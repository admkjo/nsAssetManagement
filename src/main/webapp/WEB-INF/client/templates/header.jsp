	...
	<div id="wrapper">
		...
		<div class="left side-menu">
			<div class="sidebar-inner slimscrollleft">
				...
				<div id="sidebar-menu">
					<ul>
						<%-- <li><a href='<spring:url value="clientdashboard" />'><i
								class='icon-home-3'></i> <span>Dashboard</span> <span
								class="pull-right"> </span> </a></li> --%>
						<li><a href='<spring:url value="institutionprofile" />'><i
								class=' icon-briefcase-1'></i> <span>Institution Profile</span> <span
								class="pull-right"> </span> </a></li>
