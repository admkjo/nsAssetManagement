								...
								<table class="table table-hover table-message">
									<tbody>
										<tr class="unread">
											...
											<td><a href='<spring:url value="client_selected_message"/>'>Newsletter</a></td>
											<td><a href='<spring:url value="client_selected_message"/>'>Veniam marfa mustache skateboard adipisicing</a></td>
										...
										<tr class="unread">
											...
											<td><a href='<spring:url value="client_selected_message"/>'>Support Company</a></td>
											<td><a href='<spring:url value="client_selected_message"/>'>Veniam marfa mustache skateboard adipisicing</a></td>
											<td></td>
											<td>17:25</td>
										</tr>
										<tr class="unread">
											...
											<td><a href="javascript:;"><i class="icon-star-1 warning"></i></a></td>
											<td><a href='<spring:url value="client_selected_message"/>'>Newsletter</a></td>
											<td><a href='<spring:url value="client_selected_message"/>'><span class="label label-danger">Work</span> Veniam marfa mustache skateboard adipisicing</a></td>
											<td></td>
											<td>14:12</td>
										</tr>
										<tr class="unread">
											...
											<td><a href='<spring:url value="client_selected_message"/>'>John Doe</a></td>
											<td><a href='<spring:url value="client_selected_message"/>'>Veniam marfa mustache skateboard adipisicing</a></td>
											<td><i class="icon-attach-3" data-toggle="tooltip" title="Business Contract.pdf - 2,238KB"></i></td>
											<td>13:30</td>
										</tr>
										<tr>
											...
											<td><a href="javascript:;"><i class="icon-star-empty-1 warning"></i></a></td>
											<td><a href='<spring:url value="client_selected_message"/>'>John Doe</a></td>
											<td><a href='<spring:url value="client_selected_message"/>'><span class="label label-success">Social</span> Veniam marfa mustache skateboard adipisicing</a></td>
											<td></td>
											<td>Today</td>
										</tr>
										<tr>
											...
											<td><a href="javascript:;"><i class="icon-star-empty-1 warning"></i></a></td>
											<td><a href='<spring:url value="client_selected_message"/>'>Support Company</a></td>
											<td><a href='<spring:url value="client_selected_message"/>'>Lorem ipsum dolor sit amet</a></td>
											<td></td>
											<td>Today</td>
										</tr>
										<tr>
										...
										<tr>
											<td><input type="checkbox" class="rows-check"></td>
											<td><a href="javascript:;"><i class="icon-star-empty-1 warning"></i></a></td>
											<td><a href='<spring:url value="client_selected_message"/>'>Annisa Rusmanovski</a></td>
											<td><a href='<spring:url value="client_selected_message"/>'>Veniam marfa mustache skateboard adipisicing</a></td>
											<td><i class="icon-attach-3" data-toggle="tooltip" title="Business Contract.pdf - 2,238KB"></i></td>
											<td>Oct 03, 2013</td>
										</tr>
