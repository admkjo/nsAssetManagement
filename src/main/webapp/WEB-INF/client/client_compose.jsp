	...
	<div class="content-page">
		...
		<div class="content">
			...
			<div class="page-heading">
				<h1>
					<i class='fa fa-envelope'></i> Compose
				</h1>
			</div>
			<!-- Page Heading End-->
				...
				<div class="row">
					<div class="col-md-3">
						...
						<div class="btn-group new-message-btns stacked">
							<a href='<spring:url value="client_inbox"/>'
										...
										<div class="col-sm-1 col-xs-3 text-right">
											<div class="btn-group">
												<a class="btn btn-default btn-xs" href="javascript:;"
													onclick="$('.cc-hidden').toggleClass('hidden')">Cc</a> <a
													class="btn btn-default btn-xs" href="javascript:;"
													onclick="$('.bcc-hidden').toggleClass('hidden')">Bcc</a>
											</div>
										</div>
									</div>
									...
									<div class="row">
										...
										<div class="col-xs-4">
											<p class="quick-post message">
												<a href="javascript" title="Attach Picture"
													data-toggle="tooltip"><i class="fa fa-picture-o"></i></a> <a
													href="javascript" title="Attach Video"
													data-toggle="tooltip"><i class="fa fa-video-camera"></i></a>
												<a href="javascript" title="Attach Files"
													data-toggle="tooltip"><i class="fa fa-paperclip"></i></a>
											</p>
										</div>
									</div>
								</form>
