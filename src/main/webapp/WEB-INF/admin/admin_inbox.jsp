								...
								<table class="table table-hover table-message">
									<tbody>
										...
										<tr class="unread">
											...
											<td><a href="javascript:;"><i class="icon-star-1 warning"></i></a></td>
											<td><a href='<spring:url value="admin_selected_message"/>'>Newsletter</a></td>
											<td><a href='<spring:url value="admin_selected_message"/>'><span class="label label-danger">Work</span> Veniam marfa mustache skateboard adipisicing</a></td>
											<td></td>
											<td>14:12</td>
										</tr>
										<tr class="unread">
										...
										<tr>
											...
											<td><a href="javascript:;"><i class="icon-star-empty-1 warning"></i></a></td>
											<td><a href='<spring:url value="admin_selected_message"/>'>John Doe</a></td>
											<td><a href='<spring:url value="admin_selected_message"/>'><span class="label label-success">Social</span> Veniam marfa mustache skateboard adipisicing</a></td>
											<td></td>
											<td>Today</td>
										</tr>
										<tr>
